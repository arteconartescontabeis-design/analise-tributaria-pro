...
const INC_CHANGELOG = [
  ['1.7.1','16/09/2026','<b>🔧 Correção do PDF real da v1.7.0 (análise 4, 3 empresas).</b> Cabeçalhos com nome de empresa não quebravam linha (<code>.num{white-space:nowrap}</code>) e empurravam a tabela para fora da folha, enquanto a coluna do indicador encolhia a uma letra por linha; o empacotador media essas linhas altíssimas na tela e fechava folhas quase vazias. Agora: cabeçalhos quebram, números não, primeira coluna com largura mínima; empacotador só repagina se a folha na tela tiver a largura do papel; partes do quadro dividido equilibradas (sem parte de 1 coluna) e ranking sem "Reforma acum." no parecer; <b>snapshot reaberto</b> passa de novo pelo motor para as seções por tributo, regimes e memória (antes saíam zeradas — só "Total do regime"); rótulos curtos no gráfico Antes × Depois.'],
  ['1.7.0','16/09/2026','<b>📐 Relatórios que nunca cortam + memória de cálculo completa — Demonstrativo de 15/09.</b> Paginação por <b>medição real</b> no navegador (retrato e paisagem, tabelas quebram por linha com o cabeçalho repetido); <b>limite de colunas</b> por orientação (7 retrato · 11 paisagem): a coluna "Leitura" vira notas numeradas, o parecer mostra a versão compacta dos quadros largos (abertura completa nos Relatórios 2, 3 e 7) e o que ainda não cabe é dividido em partes; régua mede altura <b>e largura</b> de cada folha; orientação única por documento (vale em Firefox/Safari) e "Todos" em dois PDFs (gerencial retrato · técnico paisagem); corrigido o @page paisagem que ficava ligado ao voltar da apresentação ao parecer. <b>Relatório 7</b> refeito em 8 blocos (entradas, consolidação com a média ponderada aberta, Simples com nominal/parcela a deduzir/efetiva e partilha, Lucro Presumido, Lucro Real, Reforma ano a ano, Δ e score, conciliação ao centavo); Excel do Relatório 7 com fórmulas de planilha; premissas sem duplicação. Motor, lacre, Δ, classificação e score intocados. Suíte: bloco 14.'],
  ['1.6.0','15/09/2026','<b>🎨 Redesign dos relatórios — "Prompt Redesign" de 15/09.</b> Duas camadas: <b>gerencial</b> e <b>técnica</b>, lendo o mesmo modelo (motor, fórmulas, classificação e premissas intocados). <b>Relatório 1 — Parecer Executivo</b> refeito em 9 páginas na ordem <i>resultado → gráfico → interpretação → conclusão</i>: capa; <b>Decisão da incorporação</b> (12 cards: conclusão, cenário, regime, score, carga atual, após, economia anual e %, Reforma acumulada, riscos, pendências, regime não permitido, sentido inverso); Antes × Depois (gráfico de barras + tabela curta); Regimes (barras horizontais, "NÃO PERMITIDO" nunca é opção); <b>Economia por tributo</b> (cascata/waterfall 🟢🔴⚪ + tabela Antes/Depois/Diferença + impacto líquido); Reforma 2027–2033 (linhas separadas × consolidada, acumulado, ★ ano de maior vantagem, ponto de inversão, "vantajosa em toda a transição: SIM/NÃO"); Ranking (barras de score + tabela enxuta); <b>Semáforo</b> da operação (🟢🟡🔴⚪ — "não avaliado" nunca é negativo), pontos favoráveis × pontos de atenção só com o que os dados mostram, riscos e pendências; Conclusão final (operação, benefício, riscos, condições) + <b>checklist de próximos passos</b>. <b>Interpretação automática</b> após cada gráfico, escrita só com números calculados. <b>Parecer Consolidado</b> ganha um <b>Resumo executivo de 3 páginas</b> (dashboard, Antes × Depois, regimes, Reforma, ranking, semáforo) antes das 20 seções; a seção 3 vira "Contexto e leitura analítica" (sem duplicar o resumo). Relatórios 4, 5 e 6 passam a se chamar "Informações … pendentes" quando faltam dados, com a lista de documentos necessários. <b>Relatórios técnicos 2, 3 e 7 em A4 paisagem</b> (página nomeada, paginador próprio) para as tabelas largas; gráficos com tamanho fixo e nunca divididos entre páginas; títulos não ficam órfãos. Formato único: R$ 1.234.567,89 · -R$ 35.000,00 · 12,34%. Relatório 8 abre com o semáforo. Motor, modelo (incModelo), Edge Function e Excel inalterados.'],
  ['1.5.0','15/09/2026','<b>📑 Relatórios remodelados — "Prompt Mestre de 14/09" (plano aprovado em 15/09).</b> Um <b>modelo único</b> (<code>incModelo</code>) alimenta tudo: <b>Parecer Consolidado de Incorporação</b> com 20 seções (identificação, objetivo e escopo, resumo, <b>painel de decisão</b>, separadas, separadas × consolidada, <b>comparação por tributo com base → alíquota → fórmula → A → B → separadas → consolidada → Δ → leitura → motivo</b> — o DAS aberto em IRPJ/CSLL/PIS/COFINS/CPP/ICMS/ISS/IPI pela partilha do motor —, regimes com <b>resultado após tributos e margem</b> e "Não permitido — motivo", Reforma ano a ano com <b>IBS e CBS separados, Δ %, acumulado, ano em que a vantagem começa e ano em que inverte</b> e aviso de alíquotas projetadas, ranking com incorporadora/incorporada/regime/resultado/estabilidade e justificativa por linha, operações, alertas e inconsistências, conclusões em <b>seis dimensões</b> (tributária, financeira, patrimonial, <b>societária</b>, Reforma, global — "Não avaliada por ausência de dados suficientes." quando não há dados), <b>recomendação condicionada</b>, premissas, limitações, memória resumida com identificador da análise). <b>Classificação em 5 categorias</b> (FAVORÁVEL · FAVORÁVEL COM RESSALVAS · NEUTRO · DESFAVORÁVEL · ANÁLISE INCOMPLETA) sobre o mesmo score (limiares 40/60; dimensão pendente ⇒ no máximo COM RESSALVAS) — a palavra "recomendado" sai. <b>Sinal único</b>: Δ = consolidada − separadas em todo relatório (positivo = acréscimo, vermelho; negativo = economia, verde) com coluna "Leitura". <b>8 relatórios separados</b> (Executivo, Comparativo Tributário Completo, Reforma com sensibilidade do crédito e abertura por ente, Financeira, Patrimonial e Endividamento — estrutura e checklist, Societária e Operacional — checklist de providências, Memória de Cálculo, Riscos/Pendências/Checklist) e <b>"Todos os relatórios — um PDF só"</b>. <b>Exportação Excel</b> (SheetJS, uma aba por seção, números como número). Apresentações simplificada/completa passam a ler o modelo (classificação, pendências, societária, recomendação). Cenário 1 (separadas) sai da coluna de score e vira "referência". Motor intocado; arquivo regerado do index v7.94.2 (lacre <code>22197ef1</code>). Edge Function <code>gerar-parecer-incorporacao</code> ganha 3 chaves (objetivo, conclSoc, recomendacaoCond) e o bloco classificacao5 — republicar.'],
  ['1.4.0','13/09/2026','<b>🔄 Rebase do motor copiado: index v7.93.5 · lacre <code>453f7b32</code>.</b> O arquivo estava congelado na cópia do index v7.86.1 (lacre <code>2e1139e9</code>) enquanto o Análise Tributária Pro re-selou o motor três vezes (v7.88.0 → v7.90.0 → v7.91.0) e passou pela validação externa até a tag <code>v7.93.2-validada</code>; a suíte acusava 9 divergências e o CI ficou vermelho de 11/09 a 13/09 (passo marcado como não bloqueante até este rebase). O extrator ganhou dois blocos que o motor da Reforma passou a exigir: <code>consist</code> (helpers de consistência da v7.93.0 — Fator R na fronteira, frase única das compras, situação no Simples, notas de totais) e <code>compModulo</code> (composição de fornecedores da v7.91.0 — classificação automática, limites inferior/base/superior, confiança), inseridos antes de <code>reformaCalc</code>. O <code>body</code> da v1.3.0 volta a viver em <code>src/incorporacao_body.html</code> (o pacote anterior tinha sido descompactado na raiz do repositório). Regras novas que a consolidada herda do index sem mudança própria: art. 24 (parcela acima do limite com RBT12 travado), art. 24 I "b" (sublimite), teto de 5% do ISS em toda faixa, RBT12 direto interno/exportação, impedimento por RBAA, composição de fornecedores e sensibilidade do crédito. Fase 4 (mês da incorporação, cisão) segue no backlog.'],
  ['1.3.0','05/09/2026','<b>📑 Relatórios remodelados para a incorporação (anexo "Relatório e Prompt — versão intermediária").</b> Ficam três: <b>Parecer de Incorporação com IA</b> — capa, parecer executivo com indicadores e <b>score de atratividade 0–100</b> (tributário 60 · Reforma 20 · estabilidade 20; patrimônio e dívida fora por falta de dados, com status <b>ANÁLISE INCOMPLETA</b> quando há alerta de fronteira), <b>ranking dos cenários</b> (1 separadas · 2 A incorpora B · 3 B incorpora A — a mesma consolidação com a ordem invertida: configuração, ISS/ICMS e prejuízo fiscal da incorporadora), comparativo antes × depois com Δ R$ e %, carga tributária consolidada <b>por tributo</b>, comparativo por regime permitido, Reforma ano a ano separadas × consolidada com débito/crédito e acumulado, patrimônio e endividamento (sem dados), conclusões (tributária, financeira, patrimonial, Reforma, global), premissas e memória; <b>Conferência de cálculos</b> (Consolidada · Incorporadora · Incorporada); <b>Apresentação de Incorporação</b> simplificada (7 telas) e completa (15 telas) no padrão de telas do ATP. Retirados: comparativo de regimes, consolidado, registros, Reforma, Resumo Estatístico, produtos e o parecer/apresentação por empresa. "Acréscimo tributário" nunca "economia negativa"; nenhum número novo — tudo do motor lacrado. Edge Function <code>gerar-parecer-incorporacao</code> ganha 11 chaves de texto (republicar). Motor e lacre intocados (2e1139e9).'],
  ['1.2.0','05/09/2026','<b>📑 Relatórios: TODOS os relatórios do Análise Tributária Pro e seleção de empresa como lá.</b> Entram os seis que faltavam: <b>Parecer Reforma Tributária com IA</b> (mesma Edge Function <code>gerar-parecer</code>; para a consolidada a análise conjunta é tratada como uma empresa só), <b>Apresentação simplificada (7 telas) e completa (15 telas)</b>, <b>Consolidado analítico (4 regimes)</b>, <b>Detalhamento dos registros</b> e <b>Produtos vendidos × Reforma</b> (na consolidada, o documento de cada CNPJ em sequência, porque a classificação RTC é gravada por empresa). Seletores <b>Projeção do ano</b> e <b>Ano de referência</b> do documento no parecer e nas apresentações, como no index. A barra passa a ter o seletor <b>Empresa</b> em primeiro lugar, no padrão do Análise Tributária Pro: "Todas — lado a lado", Consolidada, Incorporadora, Incorporada(s); a apresentação é sempre uma empresa por vez. Mais 8 blocos copiados do index e conferidos pela suíte. Motor e lacre intocados (2e1139e9).'],
  ['1.1.0','05/09/2026','<b>📑 Aba Relatórios — os mesmos relatórios do Análise Tributária Pro, para a consolidada e para cada empresa isolada.</b> Quatro relatórios: <b>Conferência de cálculos</b> (memória mês a mês — bloco 0 de dados de entrada com trilha de origem, trava da 5ª faixa, sublimite, projeção, demonstrativo da Reforma ano a ano), <b>Comparativo de regimes</b> (resumo anual Simples × Lucro Presumido × Lucro Real com a memória de INSS patronal, IRPJ e CSLL e a formação da base do LR), <b>Reforma Tributária</b> (transição 2027–2033 ano a ano e abertura de IBS/CBS por tributo e por ente) e <b>Resumo Estatístico</b> (clientes e fornecedores). Exibição <b>lado a lado</b> — uma coluna por empresa: Consolidada, Incorporadora, Incorporada(s) — ou uma empresa por vez; impressão em PDF com uma empresa por página. As funções de relatório são <b>copiadas do index</b> pelo build (13 blocos novos, conferidos byte a byte pela suíte) e leem, para a consolidada, a análise conjunta que passou pelo motor lacrado; para as isoladas, a análise gravada — o mesmo que a aba Relatórios do Análise Tributária Pro mostra. No Resumo Estatístico da consolidada, os lançamentos entre as próprias empresas ficam de fora e o mesmo parceiro em duas empresas vira uma linha. Simulação reaberta de snapshot: os relatórios são gerados passando a análise gravada pelo motor atual, com aviso quando o lacre difere do da época. Motor e lacre intocados (2e1139e9).'],
...
function go(page){
  ...
  ['sim','historico','relatorios','versoes'].forEach(p => { const el = $id('page-'+p); if (el) el.style.display = p===page ? 'block' : 'none'; });
  if (page==='relatorios'){ try { rlRender(); } catch(e){ console.error('rlRender', e); } }
