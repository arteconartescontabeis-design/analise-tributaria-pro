...
const ORDEM = ['nucleo','dialogos','motor','params','helpers','normalizar','iniAtiv','folhaPerc','snEleg','prCarregar','reformaDefs','consist','auditoria','compModulo','reformaCalc','ppDoc','ppMedir',   // v1.4.0: consist e compModulo entram ANTES do reformaCalc (calcCenariosReforma os chama)
