...
function blocos(html){
  ...
  B.auditoria = faixa(/^\/\/ ═+ v7\.94\.3 · TRILHA DE AUDITORIA POR CAMPO/, /^function anSetCfg12/).txt;   // v1.7.0: AUD_*, audLista, audResumo, audQuadroHtml (a Conferência do index v7.94.3 passou a chamá-lo)
