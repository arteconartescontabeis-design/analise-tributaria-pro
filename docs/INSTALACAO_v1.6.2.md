# Instalação — Análise Imobiliária Pro v1.6.2
...
4. Conferir: `node tests/run_imob_v160.js` → 106/106 · `npm i --no-save jsdom@24 && node tests/run_imob_ui.js` → 52/52 · na tela, badge v1.6.2.
